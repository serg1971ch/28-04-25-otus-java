...
public class NotificationServiceImp implements NotificationService {
    ...
    public void sendNotificationMessage() {
        ...
        Collection<Notification> notifications = repository.findBySentDateAfter(now);
    ...
    @Transactional
    @Override
    public Notification processRemarkInput(int chatId, String commandAndData) throws IncorrectMessageException {
    ...
    @Override
    public String processRemarkInputPhoto(long chatId,  String description, int position, boolean isYes) {
        return "";
    }
}
